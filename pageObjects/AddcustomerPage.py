...
class AddCustomer:
    ...
    btnAddnew_xpath="//div[@class='pull-right']/a[@class='btn bg-blue']"
    ...
    def setNewsletter(self):
        ...
        self.driver.find_element_by_xpath(self.lstitemTeststore2_xpath).click()
    ...
    def setCustomerRoles(self,role):
        ...
        if role=="Registered":
            ...
            time.sleep(3)
            self.driver.find_element_by_xpath("//div[@class='k-multiselect-wrap k-floatwrap']/ul/li/span[2]").click()
    ...
    def ClickonCheckboxActive(self):
        self.driver.find_element_by_xpath(self.chkboxActive_xpath).click()
